          ...
          <div className="col-lg-4">
            <div className="contact-content-part pt-5 rpt-0 rmb-55 wow fadeInUp delay-0-2s">
              <div className="section-title mb-40">
                ...
                <h2>
                  Let's Build Your <span>Next Project</span>
                </h2>
                <p>
                  I'm a junior full-stack developer ready to bring your ideas to
                  life.
                </p>
              </div>
              <ul className="list-style-two">
                <li>Proficient in React & Node.js</li>
                <li>Experienced with MySQL & MongoDB</li>
